...
impl RequestRaw {
    ...
    pub unsafe fn from_raw(ptr: *const u8) -> Result<Self, ValidationError> {
        ...
        let tag: u8 = unsafe { *(ptr.add(offset_of!(RequestRaw, inner))) };

        // Validate tag value. Invalid tag values cause UB when transmuted into an enum.
        if tag >= RequestRawInner::COUNT as u8 {
    ...
    pub fn verify<'data>(
        ...
        let request = match self.inner {
            ...
            RequestRawInner::GenerateSymmetricKey { key_id, overwrite } => {
            ...
            RequestRawInner::GenerateKeyPair { key_id, overwrite } => Request::GenerateKeyPair {
                client_id,
                request_id,
                key_id: key_id.into(),
                overwrite: bool_raw_to_bool(overwrite),
            },
            RequestRawInner::ImportSymmetricKey {
                key_id,
                data_data,
                data_size,
                overwrite,
            ...
            RequestRawInner::ExportSymmetricKey {
                key_id,
                data_data,
                data_size,
            ...
            RequestRawInner::ExportPublicKey {
                key_id,
                public_key_data,
                public_key_size,
            ...
            RequestRawInner::ExportPrivateKey {
                key_id,
                private_key_data,
                private_key_size,
            ...
            RequestRawInner::IsKeyAvailable { key_id } => Request::IsKeyAvailable {
                client_id,
                request_id,
                key_id: key_id.into(),
            },
            RequestRawInner::EncryptChaChaPoly {
                key_id,
                nonce_data,
                nonce_size,
                buffer_data,
            ...
            RequestRawInner::EncryptChaChaPolyExternalKey {
                key_data,
                key_size,
                nonce_data,
                nonce_size,
            ...
            RequestRawInner::DecryptChaChaPoly {
                key_id,
                nonce_data,
                nonce_size,
                buffer_data,
            ...
            RequestRawInner::DecryptChaChaPolyExternalKey {
                key_data,
                key_size,
                nonce_data,
                nonce_size,
            ...
            RequestRawInner::EncryptAesGcmExternalKey {
                key_data,
                key_size,
                iv_data,
                iv_size,
            ...
            RequestRawInner::DecryptAesGcmExternalKey {
                key_data,
                key_size,
                iv_data,
                iv_size,
            ...
            RequestRawInner::EncryptAesCbcExternalKey {
                key_data,
                key_size,
                iv_data,
                iv_size,
            ...
            RequestRawInner::DecryptAesCbcExternalKey {
                key_data,
                key_size,
                iv_data,
                iv_size,
            ...
            RequestRawInner::CalculateAesCmac {
                key_id,
                message_data,
                message_size,
                tag_data,
            ...
            RequestRawInner::CalculateAesCmacExternalKey {
                key_data,
                key_size,
                message_data,
                message_size,
            ...
            RequestRawInner::VerifyAesCmacExternalKey {
                key_data,
                key_size,
                message_data,
                message_size,
            ...
            RequestRawInner::CalculateHmacExternalKey {
                key_data,
                key_size,
                hash_algorithm,
                message_data,
            ...
            RequestRawInner::VerifyHmacExternalKey {
                key_data,
                key_size,
                hash_algorithm,
                message_data,
            ...
            RequestRawInner::SignExternalKey {
                key_data,
                key_size,
                message_data,
                message_size,
            ...
            RequestRawInner::VerifyExternalKey {
                key_data,
                key_size,
                message_data,
                message_size,
            ...
            RequestRawInner::EcdhExternalPrivateKey {
                curve,
                public_key_data,
                public_key_size,
                private_key_data,
    ...
    fn from(request: Request) -> Self {
        match request {
            Request::GetRandom {
                ...
                inner: RequestRawInner::GetRandom {
            ...
            Request::GenerateSymmetricKey {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::GenerateSymmetricKey {
                    key_id: key_id.into(),
            ...
            Request::GenerateKeyPair {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::GenerateKeyPair {
                    key_id: key_id.into(),
                    overwrite: overwrite.into(),
                },
            },
            Request::ImportSymmetricKey {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::ImportSymmetricKey {
                    key_id: key_id.into(),
            ...
            Request::ImportKeyPair {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::ImportKeyPair {
                    key_id: key_id.into(),
            ...
            Request::ExportSymmetricKey {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::ExportSymmetricKey {
                    key_id: key_id.into(),
            ...
            Request::ExportPublicKey {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::ExportPublicKey {
                    key_id: key_id.into(),
            ...
            Request::ExportPrivateKey {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::ExportPrivateKey {
                    key_id: key_id.into(),
            ...
            Request::IsKeyAvailable {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::IsKeyAvailable {
                    key_id: key_id.into(),
                },
            },
            Request::EncryptChaChaPoly {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::EncryptChaChaPoly {
                    key_id: key_id.into(),
            ...
            Request::EncryptChaChaPolyExternalKey {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::EncryptChaChaPolyExternalKey {
                    key_data: key.as_ptr(),
            ...
            Request::DecryptChaChaPoly {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::DecryptChaChaPoly {
                    key_id: key_id.into(),
                    nonce_data: nonce.as_ptr(),
                    nonce_size: nonce.len() as u32,
                    buffer_data: buffer.as_mut_ptr(),
            ...
            Request::DecryptChaChaPolyExternalKey {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::DecryptChaChaPolyExternalKey {
                    key_data: key.as_ptr(),
                    key_size: key.len() as u32,
                    nonce_data: nonce.as_ptr(),
                    nonce_size: nonce.len() as u32,
            ...
            Request::EncryptAesGcm {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::EncryptAesGcm {
                    key_id: key_id.into(),
                    iv_data: iv.as_ptr(),
            ...
            Request::EncryptAesGcmExternalKey {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::EncryptAesGcmExternalKey {
                    key_data: key.as_ptr(),
                    key_size: key.len() as u32,
                    iv_data: iv.as_ptr(),
                    iv_size: iv.len() as u32,
            ...
            Request::DecryptAesGcm {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::DecryptAesGcm {
                    key_id: key_id.into(),
                    iv_data: iv.as_ptr(),
                    iv_size: iv.len() as u32,
                    buffer_data: buffer.as_mut_ptr(),
            ...
            Request::DecryptAesGcmExternalKey {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::DecryptAesGcmExternalKey {
                    key_data: key.as_ptr(),
                    key_size: key.len() as u32,
                    iv_data: iv.as_ptr(),
                    iv_size: iv.len() as u32,
            ...
            Request::EncryptAesCbc {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::EncryptAesCbc {
                    key_id: key_id.into(),
                    iv_data: iv.as_ptr(),
                    iv_size: iv.len() as u32,
                    buffer_data: buffer.as_mut_ptr(),
            ...
            Request::EncryptAesCbcExternalKey {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::EncryptAesCbcExternalKey {
                    key_data: key.as_ptr(),
                    key_size: key.len() as u32,
                    iv_data: iv.as_ptr(),
                    iv_size: iv.len() as u32,
            ...
            Request::DecryptAesCbc {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::DecryptAesCbc {
                    key_id: key_id.into(),
                    iv_data: iv.as_ptr(),
                    iv_size: iv.len() as u32,
                    buffer_data: buffer.as_mut_ptr(),
            ...
            Request::DecryptAesCbcExternalKey {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::DecryptAesCbcExternalKey {
                    key_data: key.as_ptr(),
                    key_size: key.len() as u32,
                    iv_data: iv.as_ptr(),
                    iv_size: iv.len() as u32,
            ...
            Request::CalculateAesCmac {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::CalculateAesCmac {
                    key_id: key_id.into(),
            ...
            Request::CalculateAesCmacExternalKey {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::CalculateAesCmacExternalKey {
                    key_data: key.as_ptr(),
                    key_size: key.len() as u32,
                    message_data: message.as_ptr(),
                    message_size: message.len() as u32,
            ...
            Request::VerifyAesCmac {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::VerifyAesCmac {
                    key_id: key_id.into(),
                    message_data: message.as_ptr(),
                    message_size: message.len() as u32,
                    tag_data: tag.as_ptr(),
            ...
            Request::VerifyAesCmacExternalKey {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::VerifyAesCmacExternalKey {
                    key_data: key.as_ptr(),
                    key_size: key.len() as u32,
                    message_data: message.as_ptr(),
                    message_size: message.len() as u32,
            ...
            Request::CalculateHmac {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::CalculateHmac {
                    key_id: key_id.into(),
            ...
            Request::CalculateHmacExternalKey {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::CalculateHmacExternalKey {
                    key_data: key.as_ptr(),
                    key_size: key.len() as u32,
                    hash_algorithm: hash_algorithm.into(),
                    message_data: message.as_ptr(),
            ...
            Request::VerifyHmac {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::VerifyHmac {
                    key_id: key_id.into(),
                    hash_algorithm: hash_algorithm.into(),
                    message_data: message.as_ptr(),
                    message_size: message.len() as u32,
            ...
            Request::VerifyHmacExternalKey {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::VerifyHmacExternalKey {
                    key_data: key.as_ptr(),
                    key_size: key.len() as u32,
                    hash_algorithm: hash_algorithm.into(),
                    message_data: message.as_ptr(),
            ...
            Request::SignExternalKey {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::SignExternalKey {
                    key_data: key.as_ptr(),
                    key_size: key.len() as u32,
                    message_data: message.as_ptr(),
                    message_size: message.len() as u32,
            ...
            Request::VerifyExternalKey {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::VerifyExternalKey {
                    key_data: key.as_ptr(),
                    key_size: key.len() as u32,
                    message_data: message.as_ptr(),
                    message_size: message.len() as u32,
            ...
            Request::EcdhExternalPrivateKey {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: RequestRawInner::EcdhExternalPrivateKey {
                    curve: curve.into(),
                    public_key_data: public_key.as_ptr(),
                    public_key_size: public_key.len() as u32,
                    private_key_data: private_key.as_ptr(),
...
impl ResponseRaw {
    ...
    pub unsafe fn from_raw(ptr: *const u8) -> Result<Self, ValidationError> {
        ...
        // Validate tag value. Invalid tag values cause UB when transmuted into an enum.
        if tag >= ResponseRawInner::COUNT as u8 {
            return Err(ValidationError::InvalidTagValue);
        }
    ...
    fn from(value: Response<'_>) -> Self {
        match value {
            ...
            Response::GetRandom {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: ResponseRawInner::GetRandom {
                    data_data: data.as_mut_ptr(),
                    data_size: data.len() as u32,
                },
            },
            Response::GenerateSymmetricKey {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: ResponseRawInner::GenerateSymmetricKey {},
            },
            Response::GenerateKeyPair {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: ResponseRawInner::GenerateKeyPair {},
            },
            Response::ImportSymmetricKey {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: ResponseRawInner::ImportSymmetricKey {},
            },
            Response::ImportKeyPair {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: ResponseRawInner::ImportKeyPair {},
            },
            Response::ExportSymmetricKey {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: ResponseRawInner::ExportSymmetricKey {
            ...
            Response::ExportPublicKey {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: ResponseRawInner::ExportPublicKey {
                    public_key_data: public_key.as_mut_ptr(),
                    public_key_size: public_key.len() as u32,
                },
            },
            Response::ExportPrivateKey {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: ResponseRawInner::ExportPrivateKey {
                    private_key_data: private_key.as_mut_ptr(),
                    private_key_size: private_key.len() as u32,
                },
            },
            Response::IsKeyAvailable {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: ResponseRawInner::IsKeyAvailable {
            ...
            Response::EncryptChaChaPoly {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: ResponseRawInner::EncryptChaChaPoly {
                    buffer_data: buffer.as_mut_ptr(),
                    buffer_size: buffer.len() as u32,
                    tag_data: tag.as_mut_ptr(),
                    tag_size: tag.len() as u32,
            ...
            Response::DecryptChaChaPoly {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: ResponseRawInner::DecryptChaChaPoly {
                    buffer_data: buffer.as_mut_ptr(),
                    buffer_size: buffer.len() as u32,
                },
            },
            Response::EncryptAesGcm {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: ResponseRawInner::EncryptAesGcm {
                    buffer_data: buffer.as_mut_ptr(),
                    buffer_size: buffer.len() as u32,
                    tag_data: tag.as_mut_ptr(),
                    tag_size: tag.len() as u32,
            ...
            Response::DecryptAesGcm {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: ResponseRawInner::DecryptAesGcm {
                    buffer_data: buffer.as_mut_ptr(),
                    buffer_size: buffer.len() as u32,
                },
            },
            Response::EncryptAesCbc {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: ResponseRawInner::EncryptAesCbc {
                    buffer_data: buffer.as_mut_ptr(),
                    buffer_size: buffer.len() as u32,
                },
            },
            Response::DecryptAesCbc {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: ResponseRawInner::DecryptAesCbc {
                    buffer_data: buffer.as_mut_ptr(),
                    buffer_size: buffer.len() as u32,
                },
            },
            Response::CalculateAesCmac {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: ResponseRawInner::CalculateAesCmac {
                    tag_data: tag.as_mut_ptr(),
                    tag_size: tag.len() as u32,
                },
            },
            Response::VerifyAesCmac {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: ResponseRawInner::VerifyAesCmac {
            ...
            Response::CalculateHmac {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: ResponseRawInner::CalculateHmac {
                    tag_data: tag.as_mut_ptr(),
                    tag_size: tag.len() as u32,
                },
            },
            Response::VerifyHmac {
                ...
                client_id: client_id.into(),
                request_id: request_id.into(),
                inner: ResponseRawInner::VerifyHmac {
                    verified: verified.into(),
                },
            },
            Response::Sign {
